...
<head>
    ...
    <title>Church Accounting - Login</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('images/church-bg.jpg') no-repeat center center fixed;
...
<body>
    <div class="login-container">
        ...
        <h1>City Mission Church</h1>
        <p class="welcome-message">Accounting System Login</p>
        ...
        <div class="admin-link">
            <a href="admin_login.php"><i class="fas fa-lock"></i> Admin Access</a>
        </div>
    </div>
</body>
</html>